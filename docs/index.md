...
Many new members have joined and likely missed some of the earlier
messages. PredictWind is working on new release for their datahub that
...
A crafty kiwi crew member on Wild Orchid is working on a program that can
...
source, such as using option 1. This is a work in progress - as of now there is
a program which compares the Starlink position to the GPS position and prints
the Starlink position and offset from GPS.
